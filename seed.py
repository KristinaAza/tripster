...
trip1 = Trip(name="Yosemite", trip_date=datetime.date(2010, 5, 1), user_id=1, deleted=False)
trip2 = Trip(name="San Diego", trip_date=datetime.date(2020, 10, 2), user_id=1, deleted=False)
...
template1 = Template(name="Camping", user_id=1, deleted=False)
template2 = Template(name="Backpacking", user_id=1, deleted=False)
